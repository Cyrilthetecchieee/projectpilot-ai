...
export interface Task { id: string; title: string; milestone: string; priority: Priority; status: TaskStatus; dependency?: string; successCriteria: string; description?: string; milestone_id?: string; estimated_effort?: string; estimatedEffort?: string; dependencies?: string[]; related_requirements?: string[]; relatedRequirements?: string[]; related_components?: string[]; relatedComponents?: string[]; success_criteria?: string[]; successCriteriaList?: string[]; is_critical_path?: boolean; isCriticalPath?: boolean }
